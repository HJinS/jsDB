...
| Buffer Pool             | `BufferPoolManager`, `Frame`, `MidpointLRUPolicy`               | 완료                               | [Buffer Pool 문서](./docs/buffer-pool/buffer-manager.md) |
| Page                    | `SlottedPage`, `FreeSpaceManager`                               | 완료                               |                                                        |
| Index                   | `BTree`(disk-based) + `LockManager` / `PageLock`(Latch Crabbing) | 완료                              | [latch crabbing](./docs/index/btree-latch-crabbing.md) |
| Index (in-memory)       | `index/btree/inMemory/*`                                        | 완료 (page 기반 index 구현 전 index)    |
| Storage                 | `StorageManager` (CRUD 인터페이스)                                   | 진행중                              |
| Encoding                | `index/serializer/*`, `index/util/Encoder` (Row/Value 바이트 인코딩)  | 진행중                              | [encoding](./docs/encoding/key-value-encoding.md)      |
