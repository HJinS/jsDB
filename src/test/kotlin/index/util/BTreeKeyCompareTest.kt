...
class BTreeKeyCompareTest {
    ...
    fun `테스트_compare_unpacked_key_int_long`() {
    ...
    fun `테스트_compare_unpacked_key_int_desc_long`() {
        val value = listOf<Number>(10, 5230L)
    ...
    fun `테스트_compare_unpacked_key_string_boolean`() {
    ...
    fun `테스트_compare_unpacked_key_string_desc_boolean_desc`() {
        val value = listOf("Alice", true)
        val findKey = listOf("Alice")
        val schema = KeySchema(
            listOf(
    ...
    fun `테스트_compare_unpacked_key_byte_short`() {
    ...
    fun `테스트_compare_unpacked_key_byte_desc_short_desc`() {
        val value = listOf(10.toByte(), 100.toShort())
        val findKey = listOf(10.toByte())
        val schema = KeySchema(
            listOf(
    ...
    fun `테스트_compare_unpacked_key_float_double`() {
    ...
    fun `테스트_compare_unpacked_key_float_desc_double_desc`() {
        val value = listOf(10.0F, 100.0)
        val findKey = listOf(10.0F)
        val schema = KeySchema(
            listOf(
    ...
    fun `테스트_compare_unpacked_key_local_date_local_date_time`() {
    ...
    fun `테스트_compare_unpacked_key_local_date_desc_local_date_time_desc`() {
        val value = listOf(LocalDate.of(2024, 1, 1), LocalDateTime.of(2024,1,1,23,0,0))
        val findKey = listOf(LocalDate.of(2024, 1, 1))
        val schema = KeySchema(
            listOf(
    ...
    fun `테스트_compare_unpacked_key_instant_bytes`() {
    ...
    fun `테스트_compare_unpacked_key_instant_desc_bytes_desc`() {
        val value = listOf(Instant.ofEpochSecond(100), ByteBuffer.allocate(2).putShort(10).array())
        val findKey = listOf(Instant.ofEpochSecond(100))
        val schema = KeySchema(
            listOf(
        ...
        val findKey4 = listOf(Instant.ofEpochSecond(100), ByteBuffer.allocate(3).putInt(32769).array())
        val result4 = value.compareUnpackedKey(findKey4, schema)
        val packedKey4 = KeyTool.pack(findKey4, schema)
        val resultPacked4 = packedValue.comparePackedKey(packedKey4, schema)
        assertEquals(result4, 1)
